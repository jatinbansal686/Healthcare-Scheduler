// // ============================================================
// // ChatWindow.tsx — Main chat UI with message list + input bar
// // Consumes useAgentChat hook for all state management
// // ============================================================
...
//   // Sync chat error to local error state
//   useEffect(() => {
//     if (chat.error) {
//       setError(chat.error);
//     }
...
//         {/* Loading dots when agent is thinking but no tool events yet */}
...
// ============================================================
// ChatWindow.tsx — Main chat UI with message list + input bar
// OCP: Extended to pass slot selection handler to MessageBubble.
//      All existing layout and behaviour unchanged.
// ============================================================
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-1">
        ...
        {chat.messages.map((msg) => (
          <MessageBubble
            key={msg.id}
            message={msg}
            // Pass slot handler + loading state so cards know when to disable
