...
// ============================================================
// components/chat/SlotCards.tsx
// UI CHANGE: Responsive grid (1-col mobile → 2-col sm+),
//            proper overflow handling, larger touch targets.
// Logic/parsing unchanged.
// ============================================================
          ...
          return (
            <button
              ...
              className="
                ...
                bg-teal-50 px-3 py-3 text-left w-full
            ...
            >
              ...
              {/* Slot details — min-w-0 prevents text overflow */}
              <div className="flex-1 min-w-0 overflow-hidden">
                {day && (
                  <p className="text-xs font-semibold text-teal-700 uppercase tracking-wide truncate">
                    {day}
                  </p>
                )}
                {date && (
                ...
                {time && (
                  <p className="text-xs sm:text-sm text-teal-600 font-semibold truncate">
                    {time}
                  </p>
                )}
                {!day && !date && (
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4 flex-shrink-0 text-teal-400 group-hover:text-teal-600 transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
