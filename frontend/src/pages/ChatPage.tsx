...
//           <span className="text-teal-600 font-bold text-base sm:text-lg tracking-tight">
//             HealthSchedule
//           </span>
...
const ChatPage: React.FC = () => {
  ...
  return (
    <div className="flex h-[100dvh] flex-col overflow-hidden bg-gradient-to-br from-teal-50 via-white to-slate-100">
      {/* ── Top nav bar ── */}
      <header className="flex-shrink-0 flex items-center justify-between border-b border-slate-200 bg-white px-4 sm:px-6 py-3 shadow-sm z-10">
