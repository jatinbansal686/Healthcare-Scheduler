...
// CHANGE: Therapists StatCard is now clickable → opens TherapistModal.
//         All stat values come from real data.stats fields.
//         Logic/hooks/auth unchanged.
// ============================================================
...
const AdminPage: React.FC = () => {
  ...
  // Controls therapist detail modal
            ...
            <section aria-label="Overview stats">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                <StatCard
                  ...
                  color="teal"
                />
                {/* Therapists card — clickable, opens modal */}
                <StatCard
                  label="Therapists"
                  value={data.stats.totalTherapists}
                  icon="🩺"
